...
const Hero = ()=>{
    return <div className="border-b border-neutral-900 pb-4 lg:mb-6">
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    <h1 className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Kalesha Vali</h1>
            ...
            <div className="w-full lg: w-1/2 lg:p-8">
                <div className="flex justify-center">
                    <img src={profilepic} alt="Kalesha Vali"/>
                </div>
            </div>
        </div>
    </div>
